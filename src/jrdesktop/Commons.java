...
public class Commons {
   ...
   public static InetAddress iAddress;
   public static String currentIp;
   
    public static String defaultServerAddress = currentIp;
    ...
    public static final String defaultUsername = "kady";
    public static final String defaultPassword = "kady";
    ...
    public static final String proxyServer = currentIp;
    ...
    public static String CONFIG_FILE = "kadinio.conf";
    ...
    public static final String kadinio_version = "1.2.0.0";
    public static String kadinio_build_date = "2024-01-18";
  ...
  //System.out.println("Current IP address : " +currentIp); //gives only host address
       ...
       if (System.getSecurityManager() == null)
        ...
        HOME_DIR += ".kadinio" + File.separatorChar;
        CONFIG_FILE = HOME_DIR + "kadinio.conf";
        TRUST_STORE = HOME_DIR + "truststore";
        KEY_STORE = HOME_DIR + "keystore";
        java_version = SystemProperties.getJavaVersion();
        kadinio_build_date = FileUtility.getBuiltDate();
    }
}