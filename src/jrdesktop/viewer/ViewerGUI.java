...
public class ViewerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemAbout.setText("About Kadysoft Ltd.");
        jMenuItemAbout.setToolTipText("About Kadysoft");
        ...
        layout.setHorizontalGroup(
            ...
            .add(jToolBar1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1333, Short.MAX_VALUE)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .add(jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1321, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 859, Short.MAX_VALUE)
                .addContainerGap())
        );

        setSize(new java.awt.Dimension(1349, 910));
    ...
    private void jBtnStartStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnStartStopActionPerformed
        ...
        if (recorder.isRecording()) {                       
            ...
            setTitle("kadinio Viewer [" + recorder.config.server_address + "]");
        } else {
            setTitle("kadinio Viewer");
            setIconImage(new ImageIcon(Commons.WAIT_ICON).getImage());
...
private void jMenuItemAboutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAboutActionPerformed
   // main.displayTab(4);
   JOptionPane.showMessageDialog(null, "Here we are, Kadysoft Ltd, Ahmed Elkady - CEO and Founder.");
